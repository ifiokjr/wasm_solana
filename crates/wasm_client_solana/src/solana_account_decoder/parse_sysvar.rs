...
use solana_sdk::slot_history::{self};
...
// epoch_rewards.distribution_starting_block_height, 			num_partitions:
// epoch_rewards.num_partitions, 			parent_blockhash:
// epoch_rewards.parent_blockhash.to_string(), 			total_points:
// epoch_rewards.total_points, 			total_rewards: epoch_rewards.total_rewards,
