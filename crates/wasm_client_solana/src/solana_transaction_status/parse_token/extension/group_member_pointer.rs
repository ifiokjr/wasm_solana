use spl_token_2022::extension::group_member_pointer::instruction::*;
use spl_token_2022::instruction::decode_instruction_data;
use spl_token_2022::instruction::decode_instruction_type;

use super::*;

pub(in crate::solana_transaction_status::parse_token) fn parse_group_member_pointer_instruction(
	instruction_data: &[u8],
	account_indexes: &[u8],
