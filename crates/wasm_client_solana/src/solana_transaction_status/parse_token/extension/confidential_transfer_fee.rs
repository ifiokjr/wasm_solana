...
use super::*;
use crate::solana_account_decoder::parse_token_extension::UiConfidentialTransferFeeConfig;

pub(in crate::solana_transaction_status::parse_token) fn parse_confidential_transfer_fee_instruction(
	instruction_data: &[u8],
	account_indexes: &[u8],
		...
		.map_err(|_| ParseInstructionError::InstructionNotParsable(ParsableProgram::SplToken))?
	{
		...
		ConfidentialTransferFeeInstruction::WithdrawWithheldTokensFromAccounts => {
			...
			for i in &account_indexes[first_source_account_index..] {
