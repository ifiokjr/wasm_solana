...
use super::*;
use crate::solana_account_decoder::parse_token_extension::UiConfidentialTransferMint;

pub(in crate::solana_transaction_status::parse_token) fn parse_confidential_transfer_instruction(
	instruction_data: &[u8],
	account_indexes: &[u8],
		...
		.map_err(|_| ParseInstructionError::InstructionNotParsable(ParsableProgram::SplToken))?
	{
		...
		ConfidentialTransferInstruction::ConfigureAccountWithRegistry => todo!(),
	}
}
