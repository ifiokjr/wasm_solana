...
impl MemoryWallet {
	...
	pub fn set_account(&mut self, account: impl Into<MemoryWalletAccountInfo>) {
	...
	pub fn set_account_with_pubkey(&mut self, pubkey: &Pubkey) {
...
impl WalletSolanaSignAndSendTransaction for MemoryWallet {
	...
	async fn sign_and_send_transaction(
		...
		transaction.try_sign(&[&**account], blockhash)?;
