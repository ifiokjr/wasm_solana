...
use spl_token_2022_interface::extension::permissioned_burn::instruction::BurnCheckedInstructionData;
use spl_token_2022_interface::extension::permissioned_burn::instruction::BurnInstructionData;
use spl_token_2022_interface::extension::permissioned_burn::instruction::InitializeInstructionData;
...
pub(in crate::parse_token) fn parse_permissioned_burn_instruction(
		...
		.map_err(|_| ParseInstructionError::InstructionNotParsable(ParsableProgram::SplToken))?
	{
		...
		PermissionedBurnInstruction::ConfidentialBurn => {
			...
			// trailing accounts; everything between the mint and them is
...
mod test {
	...
	use spl_token_2022_interface::extension::permissioned_burn::instruction::burn;
	use spl_token_2022_interface::extension::permissioned_burn::instruction::confidential_burn_with_split_proofs;
	use spl_token_2022_interface::extension::permissioned_burn::instruction::initialize;
